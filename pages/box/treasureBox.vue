    ...
    <view class="kaixiang">
        ...
        <view class="shop-list">
            ...
            <template v-else>
                <template v-if="boxLogList.length">
                    <mescroll-body ref="mescrollRef" height="400" @init="mescrollInit" @down="downCallback"
                        @up="getList" :down="downOption" :up="upOption">
                                ...
                                <template v-if="item.is_box == 0">
                                    <view class="award-single-info">
                                        ...
                                        <view class="award-log-box">
                                            <image class="award-single-img" :src="item.thumb" mode="widthFix"
                                    ...
                                    <view class="award-box-content">
                                        ...
                                        <view class="box-award-content">
                                            ...
                                            <view class="award-log-box-items">
                                                ...
                                                <view v-for="(subItem, subIndex) in item.sub_orders" :key="subIndex"
                                                    class="sub-item">
            ...
            <view v-if="orderData" class="order-pop">
                <view class="order-pop-hd">
                    ...
                    <view @click="closeOrderPop" class="close icon">
                        <image
                            src="https://img.alicdn.com/imgextra/i3/2200676927379/O1CN01peY2tu24Ndcpz3gHV_!!2200676927379.png"
                            mode="scaleToFill" />
                    </view>
                </view>
                ...
                <view class="order-pop-bd">
                    ...
                    <view class="row">
                        ...
                        <view class="right">
                            <view class="price red" v-if="orderData.couponCount" @click="goCoupon">
                                <template v-if="coupon_info && coupon_info.name">{{ coupon_info.name }}<u-icon
                                        name="arrow-right" color="#d5b644" size="28"></u-icon></template>
                                <template v-else> <text>{{ orderData.couponCount }}张可用</text><u-icon name="arrow-right"
                    ...
                    <view class="pay-type">
                        <view @click.stop="changePayType(i)" v-for="(item, i) in payTypeList" :key="i"
                            class="pay-type-item">
                            <view class="icon">
                    ...
                    <view class="agree">
                        ...
                        <evan-switch v-model="agree" active-color="#7768d5" inactive-color="#fff" :size="20"
                            :active-value="true" :inactive-value="false"></evan-switch>
                    </view>
            ...
            <view class="detail-pop">
                ...
                <scroll-view class="detail-pop-bd" scroll-y>
                    <view class="detail-pic" v-if="curDetail.thumb">
                        ...
                        <image class="" :src="curDetail.thumb" mode="aspectFit" lazy-load="false" binderror=""
                            bindload="" />
                    </view>
        ...
        <u-popup v-model="zsPop" mode="bottom" border-radius="16" height="70%">
            <view class="zsbox-wrap">
                ...
                <mescroll-uni ref="mescrollRef" @init="mescrollInit" @down="downCallback" @up="getBoxLogList"
                    ...
                    <view class="award-wrap">
                        <view class="award-log-item" :style="{ backgroundImage: `url(${item.image})` }"
                            ...
                            <view class="award-log-right">
                                <image class="award-log-img" :src="item.thumb" mode="widthFix" lazy-load="false"
                                    binderror="" bindload="" />
                            </view>
                        </view>
                    </view>
                    ...
                    <view class="couList" v-for="(item, idx) in couponList" :key="idx">
                        ...
                        <view class="r">
                            <view class="ll">
                                ...
                                <view class="qi">{{ item.valid_from.substring(0, 11) }}至{{ item.valid_until.substring(0,
                                    11) }}
                                </view>
                            </view>
